    ...
    <div className="option-panel space-y-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
        ...
        <div className="md:col-span-2">
          ...
          <input type="number" step="1" {...register(`options.${index}.loan_amount`, { valueAsNumber: true })} readOnly className="w-full mt-1 p-2 border rounded bg-gray-100 cursor-not-allowed" />
        </div>
        <div className="md:col-span-2">
          <label className="block text-l font-medium font-bold">Nett Price</label>
          <input type="number" step="1" {...register(`options.${index}.nett_price`, { valueAsNumber: true })} readOnly className="w-full mt-1 p-2 border rounded border-gray-400 bg-gray-100 cursor-not-allowed" />
        </div>
        <div className="md:col-span-2">
        ...
        <div className="md:col-span-2">
          ...
          <input type="number" step=".01" {...register(`options.${index}.monthly_instalment`, { valueAsNumber: true })} readOnly className="w-full mt-1 p-2 border rounded bg-gray-100 cursor-not-allowed" />
        </div>
      </div>
